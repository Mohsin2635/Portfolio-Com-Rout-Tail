...
const Projects = () => {
  return (
    <>
      <div className="w-full h-full overflow-hidden place-items-center px-[5%] sm:px-[7%] md:px-[10%] mt-10 md:mt-0 text-white pb-14">
        <div>
          <h1 className="mt-10 font-bold text-center sm:text-left">My Projects</h1>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 overflow-hidden mt-3 gap-10 ">
            <div className="work md:w-full h-[500px] md:h-[400px] mt-10 relative rounded-xl overflow-hidden">
              <Image
                src={image1}
                alt="image"
