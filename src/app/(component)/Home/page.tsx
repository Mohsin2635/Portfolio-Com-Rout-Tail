...
const Home = () => {
  return (
    <div className="bg-black w-full h-[530px] flex relative md:justify-between overflow-hidden 2xl:justify-evenly">
      <div className="text-white px-[5%] py-52 sm:px-[7%] md:pl-[10%] z-10">
